...
-- Exit with jk
map({ "!", "t" }, "jk", [[<c-\><c-n>]], { desc = "Exit to normal mode" })
...
map({ "n" }, "<leader>wp", "<C-W>p", { desc = "Go to previous window", remap = true })
map({ "n" }, "<leader>wt", "<C-W>t", { desc = "Go to top left window", remap = true })
map({ "n" }, "<leader>wb", "<C-W>b", { desc = "Go to bottom right window", remap = true })
map({ "n" }, "<leader>ww", "<C-W>w", { remap = true })
...
if vim.lsp.buf.inlay_hint or vim.lsp.inlay_hint then
  ...
  map( "i", "<C-h>", function() LazyVim.toggle.inlay_hints() end, { desc = "Toggle Inlay Hints" })
end
